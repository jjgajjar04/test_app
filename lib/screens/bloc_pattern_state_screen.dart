...
class BlocPatternStateScreen extends StatefulWidget {
  static const String id = Constants.BLOC_PATTERN_STATE_SCREEN;

  @override
  _BlocPatternStateScreenState createState() => _BlocPatternStateScreenState();
}

class _BlocPatternStateScreenState extends State<BlocPatternStateScreen> {
  @override
